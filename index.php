...
<?php foreach ($faqs as $key => $faq) { ?>
    <div class="accordion">
        <h3><?php echo $faq["question"] ?><i class="fas fa-chevron-down"></i> </h3>
    </div>
    <div class="panel">
    <?php {
        echo $faq["answer"];
